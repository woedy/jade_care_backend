...
from accounts.api.serializers import PatientRegistrationSerializer, DocRegistrationSerializer, AdminRegistrationSerializer
...
class ObtainAdminAuthTokenView(APIView):
    ...
    def post(self, request):
        ...
        if qs.exists():
            ...
            if qs.first().admin is not True:
                payload['response'] = "Error"
                payload['error_message'] = "You are not an admin"
                return Response(payload)
...
def logout_admin_view_api(request):
    payload = {}
    data = {}
