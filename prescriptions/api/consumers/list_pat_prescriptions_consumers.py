...
class ListPatPrescriptionsConsumer(AsyncJsonWebsocketConsumer):
    ...
    async def receive_json(self, content):
        print("ListPatPrescriptionsConsumer: receive_json")
        ...
        try:
            if command == "list_pat_prescriptions":
                ...
                self.room_group_name = 'list_pat_prescriptions_%s' % user_id
