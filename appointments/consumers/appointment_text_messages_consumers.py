...
class AppointmentTextMessagePageConsumers(AsyncJsonWebsocketConsumer):
    ...
    async def receive_json(self, content):
        print("AppointmentTextMessagePageConsumers: receive_json")
...
def get_room_chat_messages(room, page_number):
    try:
        ...
        serializers = PrivateChatRoomMessageSerializer(qs, many=True)
        if serializers:
