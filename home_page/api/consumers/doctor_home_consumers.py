...
class GetDocHomeDataConsumer(AsyncJsonWebsocketConsumer):
    ...
    async def receive_json(self, content):
        print("GetDocHomeDataConsumer: receive_json")
            ...
            if command == "get_home_data":
                ...
                await self.channel_layer.group_send(
                    self.room_group_name,
                    {
                        ...
                        'get_home_data_message': self.doc_profile
                    }
                )
    ...
    async def get_home_data(self, user_id, data):
        ...
        try:
            ...
            self.doc_profile = json.loads(profile)
        except ClientError as e:
            await self.handle_client_error(e)
